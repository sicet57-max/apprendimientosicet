...
if st.session_state['authenticated']:
    ...
    * **Reporte por Rango:** Genera y guarda un reporte de rendimiento para un rango de fechas personalizado (ej: del 31 de oct al 20 de nov).
    * **Historial Reportes:** (¡NUEVO!) Permite ver, filtrar y eliminar los reportes por rango que has guardado.
    """)
