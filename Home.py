...
if st.session_state['authenticated']:
    ...
    * **Cálculo Rendimiento:** El corazón de la app. Aquí puedes calificar, generar reportes mensuales y gestionar (modificar/borrar) los cálculos.
