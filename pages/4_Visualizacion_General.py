...
if df_calculos.empty:
    st.info("No hay datos de cálculos numéricos detallados para analizar.")
    st.stop()
...
if df_filtrado_dash.empty:
    ...
    columnas_finales_tabla = [
        'fecha', 'mes', 'dia', col_nombre_tecnico_calc, col_cedula_calc, 
        'Empresa_Info', 'Cargo_Info', 'porcentaje_rendimiento', 'comentario',
        col_creacion_hist
    ]
