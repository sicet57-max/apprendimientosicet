...
def load_all_data():
    ...
    try:
        ...
        if not df_personal.empty:
            ...
            # Limpiamos los espacios en blanco de los NOMBRES
...
lista_empleados = [""] + sorted(list(df_personal[col_nombre_tecnico].unique())) # Ordenamos la lista
...
if empleado_sel:
    ...
    if df_calculos.empty:
        ...
        # El filtro ahora comparará datos limpios (sin espacios)
